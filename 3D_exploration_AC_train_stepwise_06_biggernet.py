...
run_name = f"ckpt_3D_exploration_AC_stepwise_biggernet_{time.strftime('%d%m%Y_%H%M%S', time.localtime())}"
...
# === Network ===
net = SeekerAlphaZeroNet(obs_dim=obs_dim, action_dim=action_dim, hidden_sizes=(256, 256)).to(device)
