...
run_name = f"ckpt_3D_exploration_AC_stepwise_cpuct02_{time.strftime('%d%m%Y_%H%M%S', time.localtime())}"
...
class Config:
    ...
    cpuct: float = 0.2            # Exploration vs exploitation tradeoff in PUCT; Higher -> more exploration guided by policy prior
